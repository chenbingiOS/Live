...
-(void)setModel:(TSCChatModel *)model{
    ...
    self.nameWidth.constant = model.nameWidth.floatValue;
    
    NSString *userLevel = [NSString stringWithFormat:@"v%@", model.userLevel];
    self.levelImgView.image = [UIImage imageNamed:userLevel];
