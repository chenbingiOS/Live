...
- (void)setModel:(GiftModel *)model {
    ...
    if (model.headImage) {
        ...
        [_headImageView sd_setImageWithURL:[NSURL URLWithString:model.headImageURL] placeholderImage:[UIImage imageNamed:@"placeholder_head"]];
    }
    if (model.giftImage) {
        _giftImageView.image = model.giftImage;
    } else {
        [_giftImageView sd_setImageWithURL:[NSURL URLWithString:model.giftImageURL] placeholderImage:[UIImage imageNamed:@"placeholder_head"]];
